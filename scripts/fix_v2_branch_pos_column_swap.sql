-- Repair v2_branch_pos (mirrors branch_pos) — same scramble.
-- Usage:
--   psql -d portfolio_month_wise -v month_id=24 -f fix_v2_branch_pos_column_swap.sql
...
FROM v2_branch_pos WHERE month_id = :'month_id'::int GROUP BY month_id;

UPDATE v2_branch_pos
...
WHERE v2_branch_pos.ctid = src.rid;
